...
# 
#   list.save(u.hyps, '/home/kolonel/Programs/QuaternaryProd/inst/extdata/u.hyps.yaml')
#   list.save(child.uid, '/home/kolonel/Programs/QuaternaryProd/inst/extdata/child.uid.yaml')
#   list.save(child.sgn, '/home/kolonel/Programs/QuaternaryProd/inst/extdata/child.sgn.yaml')
# 
# }
