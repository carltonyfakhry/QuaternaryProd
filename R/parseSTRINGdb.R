...
parseStringDB <- function(){
  ...
  write.table(Rels, "/home/kolonel/Programs/QuaternaryProd/inst/extdata/newStringRels.dat", col.names = T, row.names = F)
  write.table(Ents, "/home/kolonel/Programs/QuaternaryProd/inst/extdata/newStringEnts.dat", col.names = T, row.names = F)
  ...
  list.save(u.hyps, '/home/kolonel/Programs/QuaternaryProd/inst/extdata/new.u.hyps.yaml')
  list.save(child.uid, '/home/kolonel/Programs/QuaternaryProd/inst/extdata/new.child.uid.yaml')
  list.save(child.sgn, '/home/kolonel/Programs/QuaternaryProd/inst/extdata/new.child.sgn.yaml')
